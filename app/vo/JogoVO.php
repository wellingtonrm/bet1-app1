...
class JogoVO extends ValueObject
{
    ...
    private $refImport;
    private $dataBaixa;
    private $alterouCotacoes;

    /**
     * @return mixed
     */
    public function getAlterouCotacoes()
    {
        return $this->alterouCotacoes ? 1 : 0;
    }

    /**
     * @param mixed $alterouCotacoes
     * @return $this
     */
    public function setAlterouCotacoes($alterouCotacoes)
    {
        $this->alterouCotacoes = $alterouCotacoes;
        return $this;
    }
    ...
    {
        $cotacoes = $this->getCotacoes(true);
        return $cotacoes ? ($cotacoes[90]['casa'] < $cotacoes[90]['fora'] ? 1 : 0) : 0;
    }
