...
class CategoriasModel extends Model
{
    ...
    static function options($ref, $refid = 0, $default = null, $root = 0, $nivel = 0)
    {
        ...
        $registros = self::lista("WHERE a.ref = :ref AND a.refid = :refid AND a.root = :root AND a.status = 1 ORDER BY a.ordem ASC, a.title ASC", ['ref' => $ref, 'root' => $root, 'refid' => $refid], false, true, true);
        /** @var CategoriaVO $v */
