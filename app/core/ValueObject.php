...
abstract class ValueObject implements \JsonSerializable
{
     ...
     * @param bool $soAlterados
     * @return $this
     */
    public function save(array $setValues = null, bool $soAlterados = true)
    {
        ...
        // Salvando valores
        if (!Model::save($this, $soAlterados)) {
    ...
    {
        return $this->__imagens ? $this->__imagens[0] : ImagensModel::capa($this->getImageReference($ADDReference), $this->getId(), $Default, $this->_img_default);
    }
    ...
    {
        $this->__imagens = null;
        ImagensModel::excluirTodasImagens($this->getImageReference($ADDReference), $this->getId());
        return $this;
    }
    ...
    {
        return ($this->__imagens and $this->getId()) ? $this->__imagens : ImagensModel::getByRef($this->getImageReference($ADDReference), $this->getId(), $Default, true, $this->_img_default);
    }
